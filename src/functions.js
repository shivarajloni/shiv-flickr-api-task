/*
    This file contains common utility-functions used..
*/
...
export function getImageUrl(farm, server, id, secret) {
	...
	/* Wrote Function For pagination But, could work on it to run properly due to time constraint!! */
// export function editPageNumber(number) {
// 	return {
