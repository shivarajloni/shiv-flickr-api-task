...
import ImageList from "./components/Image.js";
import ImagePopUp from "./components/ImageGrid.js";
import constants from "./api.js";
import { scrollAreaAvailable, debounce, throttle, checkHttpStatus, parseJSON } from "./functions.js";
		// had passed as prop, 'editpageNumber' function above!!
		...
		return (
			<div className="app">
				<div className="app-header">
					<h2 style={{ margin: "1rem 0" }}>Image's Search in Flickr</h2>
					...
					{this.state.queries.length > 0 &&
						<div style={{ marginTop: "16px" }}>
							<h5 style={{ marginBottom: "5px" }}>Searched Images</h5>
				...
				<div className="app-content" ref="appContent">
					{this.state.imageList.length
						...
						: <p style={{ margin: "1rem 0" }}>Search for Image's like Cat, Dog, Cars, Tress...</p>}
